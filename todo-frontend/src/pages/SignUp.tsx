...
import Todo from "../assets/logo3.png";
    ...
    <div className="">
      ...
      <div className="container mx-auto">
        <div className="flex justify-center px-6 my-12">
          {/* Row */}
          <div className="flex justify-center lg:w-10/12 w-full lg:border-b-0  xl:w-3/4 pl-6 pr-2 border-solid border-b-2 border-gray-300 pb-5 lg:pb-0">
            {/* Col */}
            <div className="w-full lg:w-7/12 bg-white p-5 rounded lg:rounded">
              ...
              <form className="px-8 pt-6 pb-8 mb-4 bg-white rounded">
                ...
                <div className="mb-6 text-center">
                  <button
                    onClick={register}
                    className="w-full px-4 py-2 font-bold text-white bg-yellow-400 rounded hover:bg-yellow-500 focus:outline-none focus:shadow-outline"
                    type="button"
                  >
                    Register Account
                  </button>
                ...
                <div className="text-center">
                  <a
                    className=" cursor-pointer line-block text-sm text-gray-500 align-baseline hover:text-black"
                    onClick={() => {
                      navigate("/login");
                    }}
                  >
